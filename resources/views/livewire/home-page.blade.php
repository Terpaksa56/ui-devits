<div>
    {{-- Hero open --}}
    <div class="w-full bg-gradient-to-r from-purple-900 to-violet-500 mx-auto px-4 xl:px-0 pt-12 lg:pt-20 pb-24">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-md" src="/assets/hero-2.png" alt="Image Description">
                    <div
    ...
    <div class="bg-max-w-7xl px-4 lg:px-8 py-12 lg:py-12 mx-auto">
        ...
        {{-- product open --}}
        <div class="product mx-auto max-w-screen-lg">
